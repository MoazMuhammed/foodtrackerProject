  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocProvider(
        ...
        child: BlocConsumer<DeleteItemFromCartCubit, DeleteItemFromCartState>(
                  ...
                  body: Column(
                    ...
                    children: [
                      ForgetPasswordBarWidget(
                          onPressed: () => pop(context), title: "Check Cart"),
                      Expanded(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  cubitDeleteItem.deleteItem(Id: items.id.toInt());
                                                },
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Text(
                                  cubit.CartDetails.totalPrice.toString() +
                                      ' EGP',
                                  style: TextStyle(fontSize: 16.sp),
                                ),
                              ],
