...
/// id : 0
/// owner_name : "string"
/// comments : [{"id":0,"owner":"string","text":"string","created_date":"2023-05-06T10:46:14.018Z","post":0}]
/// title : "string"
/// image : "string"
/// created_at : "2023-05-06T10:46:14.018Z"
/// updated_at : "2023-05-06T10:46:14.018Z"
/// allergy : 0
/// owner : 0
/// likes : [0]

EditPostModel editPostModelFromJson(String str) => EditPostModel.fromJson(json.decode(str));
String editPostModelToJson(EditPostModel data) => json.encode(data.toJson());
class EditPostModel {
  EditPostModel({
      num? id, 
      String? ownerName, 
...
/// owner : "string"
/// text : "string"
/// created_date : "2023-05-06T10:46:14.018Z"
/// post : 0
